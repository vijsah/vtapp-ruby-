...
When User enters following details in the signup form: <emailid> <firstname> <lastname> <companyname> <password> and <confirmpassword>
...
|tannaaa-arora@mail.com|Tanshika|Arora|Vinsol|abcdef|abcdef|
|tannaaa.arora@mail.com|Tanshika|Arora|Vinsol|abcdef|abcdef|
|tannaaa@mail.com|Tanshika|Arora|Vinsol|abcdef|abcdef|
|tannaaa_arora@mail.com|Tanshika|Arora|Vinsol|abcdef|abcdef|
|tannaaa.arora@mail.cc|Tanshika|Arora|Vinsol|abcdef|abcdef|
|tannaaa.arora@mail-archive.com|Tanshika|Arora|Vinsol|abcdef|abcdef|
|tannaaa.arora@mail.org|Tanshika|Arora|Vinsol|password|password|
